# Example: TypeScript SVG to TinyVG Conversion and Rendering
#
# This example demonstrates:
# 1. Loading the TypeScript logo SVG
...
proc main() =
  ## TypeScript logo conversion and rendering example
  
  let svgFile = "examples/lang/typescript.svg"
  let tvgFile = "examples/typescript.tvg"
  let htmlFile = "examples/typescript_render.html"
  
  echo "=== TypeScript SVG to TinyVG Example ==="
  echo ""
...
<head>
  <meta charset="UTF-8">
  <title>TypeScript Logo - TinyVG Render</title>
  <style>
    body {{
...
<body>
  <h1>TypeScript Logo</h1>
  <p class="subtitle">SVG to TinyVG Conversion Example</p>
  
  <div class="container">
    <div class="card">
      <h2>Original SVG</h2>
      <img src="lang/typescript.svg" width="{canvasWidth}" height="{canvasHeight}" alt="TypeScript SVG">
    </div>
